...
class BGA:
    ...
    def run(self):
        ...
        for it in tqdm(range(self.max_round), leave=False):
            next_gene = []
            ...
            if self.early_stop_rounds != None and count > self.early_stop_rounds:
                # print(
                #     "Did not improved within {} rounds. Break.".format(
        ...
        #         global_best_ind, global_best_fitness, eva_times
        #     )
        # )
